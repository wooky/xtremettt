...
class OptionsScreen:
	...
	def __init__(self, screen):
		...
		self.player_x_box = Textbox(screen, 20, self.player_x_rect.bottom + 20, screen.get_width()/2 - 40, 11)
		self.player_o_box = Textbox(screen, screen.get_width()/2 + 20, self.player_o_rect.bottom + 20, screen.get_width()/2 - 40, 11)
	...
	def logic(self):
		...
		if self.player_x_clear_photo.is_pressed(): assets.custom['x'] = None
			...
			self.next_screen = CamOverlay(self.screen, assets.custom, 'x')
		...
		if self.online:
			...
			if self.player_o_clear_photo.is_pressed(): assets.custom['o'] = None
				...
				self.next_screen = CamOverlay(self.screen, assets.custom, 'o')
